...
func initMenu(app *Application, roleID string) {
	...
	// Level 2 menus
	menuMgmt, _ := app.DB.Menu.Create().SetParentID(system.ID).SetName("菜单管理").SetSequence(1).SetType("menu").SetPath("/system/menu").SetIcon("Menu").SetIsFrame(false).SetVisible("show").AddAPIResourceIDs("GET:/api/v1/system/menu", "GET:/api/v1/system/menu/tree").SetStatus("active").Save(ctx)
	roleMgmt, _ := app.DB.Menu.Create().SetParentID(system.ID).SetName("角色管理").SetSequence(2).SetType("menu").SetPath("/system/role").SetIcon("UserCheck").SetIsFrame(false).SetVisible("show").AddAPIResourceIDs("GET:/api/v1/system/role").SetStatus("active").Save(ctx)
	userMgmt, _ := app.DB.Menu.Create().SetParentID(system.ID).SetName("用户管理").SetSequence(3).SetType("menu").SetPath("/system/user").SetIcon("Users").SetIsFrame(false).SetVisible("show").AddAPIResourceIDs("GET:/api/v1/system/user/").SetStatus("active").Save(ctx)
	// Department management
	deptMgmt, _ := app.DB.Menu.Create().SetParentID(system.ID).SetName("部门管理").SetSequence(4).SetType("menu").SetPath("/system/departments").SetIcon("Building2").SetIsFrame(false).SetVisible("show").AddAPIResourceIDs("GET:/api/v1/system/department/tree").SetStatus("active").Save(ctx)
	apiMapping, _ := app.DB.Menu.Create().SetParentID(system.ID).SetName("API资源").SetSequence(5).SetType("menu").SetPath("/system/api-resources").SetIcon("Code2").SetIsFrame(false).SetVisible("show").AddAPIResourceIDs("GET:/api/v1/system/api-resources").SetStatus("active").Save(ctx)
	loginLogs, _ := app.DB.Menu.Create().SetParentID(system.ID).SetName("登录日志").SetSequence(6).SetType("menu").SetPath("/system/login-logs").SetIcon("Layers3").SetIsFrame(false).SetVisible("show").AddAPIResourceIDs("GET:/api/v1/system/login-logs").SetStatus("active").Save(ctx)
	dictMgmt, _ := app.DB.Menu.Create().SetParentID(system.ID).SetName("字典管理").SetSequence(7).SetType("menu").SetPath("/system/dict").SetIcon("BookMarked").SetIsFrame(false).SetVisible("show").AddAPIResourceIDs("GET:/api/v1/system/dict/types", "GET:/api/v1/system/dict/items", "GET:/api/v1/system/dict/types/code/:code/items").SetStatus("active").Save(ctx)
	// Menu management buttons
	_, _ = app.DB.Menu.Create().SetParentID(menuMgmt.ID).SetName("创建菜单").SetSequence(0).SetType("button").SetPath("").SetIcon("PlusCircle").SetIsFrame(false).SetVisible("show").SetPermissions("system:menu:add").AddAPIResourceIDs("POST:/api/v1/system/menu", "GET:/api/v1/system/api-resources").SetStatus("active").Save(ctx)
	_, _ = app.DB.Menu.Create().SetParentID(menuMgmt.ID).SetName("编辑菜单").SetSequence(0).SetType("button").SetPath("").SetIcon("Edit").SetIsFrame(false).SetVisible("show").SetPermissions("system:menu:edit").AddAPIResourceIDs("PUT:/api/v1/system/menu/:id", "GET:/api/v1/system/menu/:id", "GET:/api/v1/system/api-resources").SetStatus("active").Save(ctx)
	...
	app.DB.Menu.Create().SetParentID(roleMgmt.ID).SetName("创建角色").SetSequence(0).SetType("button").SetPath("").SetIcon("Plus").SetIsFrame(false).SetVisible("show").SetPermissions("system:role:add").AddAPIResourceIDs("POST:/api/v1/system/role", "GET:/api/v1/system/menu/tree").SetStatus("active").Save(ctx)
	...
	app.DB.Menu.Create().SetParentID(roleMgmt.ID).SetName("编辑角色").SetSequence(0).SetType("button").SetPath("").SetIcon("Edit").SetIsFrame(false).SetVisible("show").SetPermissions("system:role:edit").AddAPIResourceIDs("PUT:/api/v1/system/role/:id", "GET:/api/v1/system/role/:id", "GET:/api/v1/system/role/:id/menus", "GET:/api/v1/system/menu/tree").SetStatus("active").Save(ctx)
	...
	app.DB.Menu.Create().SetParentID(userMgmt.ID).SetName("编辑用户").SetSequence(0).SetType("button").SetPath("").SetIcon("Edit").SetIsFrame(false).SetVisible("show").SetPermissions("system:user:edit").AddAPIResourceIDs("PUT:/api/v1/system/user/:id", "GET:/api/v1/system/user/:id", "GET:/api/v1/system/user/:id/roles").SetStatus("active").Save(ctx)
	// Other buttons
	...
	app.DB.Menu.Create().SetParentID(dictMgmt.ID).SetName("编辑字典类型").SetSequence(0).SetType("button").SetPath("").SetIcon("Edit").SetIsFrame(false).SetVisible("show").SetPermissions("system:dict:edit_type").AddAPIResourceIDs("PUT:/api/v1/system/dict/types/:id", "GET:/api/v1/system/dict/types/:id").SetStatus("active").Save(ctx)
