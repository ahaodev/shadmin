...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.DeviceActivateRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/domain.DeviceActivateResponse"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.DeviceCodeRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/domain.DeviceCodeResponse"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.DeviceTokenRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/auth/identity/exchange": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Identity login callback code",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.UserIdentityExchangeRequest"
                        }
                    }
                ],
                "responses": {
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/domain.UserIdentityResult"
                                        }
                                    }
                                }
                            ]
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.CreateDepartmentRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/system/department/tree": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved department tree",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/domain.Response"
        ...
        "/system/department/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/domain.UpdateDepartmentRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "409": {
                        "description": "Conflict - duplicate name or circular ref",
                        "schema": {
                            "$ref": "#/definitions/domain.Response"
                        }
                    }
            ...
            "delete": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Has children or users",
                        "schema": {
                            "$ref": "#/definitions/domain.Response"
                        }
                    },
    ...
    "definitions": {
        ...
        "domain.CreateDepartmentRequest": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "domain.UpdateDepartmentRequest": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string",
        ...
        "domain.UserIdentityExchangeRequest": {
            "type": "object",
            "required": [
                "code"
            ],
